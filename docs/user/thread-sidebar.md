...
A linked pull request also shows its number on the thread's sidebar row and in
the branch toolbar above the composer. Right-click either number for the same
